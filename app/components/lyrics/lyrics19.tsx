...
const Lyrics19 = () => {
	return (
		<div className="flex flex-col gap-2 text-left p-4 border border-[#7149C6] rounded shadow-lg">
			...
			<span className="mt-3 text-lg text-neutral-500">Säe 2</span>
			<span className="text-lg">
			...
			<span className="mt-3 text-lg text-neutral-500">Kertosäe</span>
			<span className="text-lg">
			...
			<span className="mt-3 text-lg text-neutral-500">Säe 3</span>
			<span className="text-lg">
			...
			<span className="mt-3 text-lg text-neutral-500">Säe 4</span>
			<span className="text-lg">
			...
			<span className="mt-3 text-lg text-neutral-500">Tuplakertosäe</span>
		</div>
	);
};

export default Lyrics19;
